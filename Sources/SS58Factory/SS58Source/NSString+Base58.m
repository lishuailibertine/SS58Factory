...
+ (NSString *)base58checkWithData:(NSData *)d {
    NSMutableData *base58Data = [NSMutableData new];
    [base58Data appendData:d];
    [base58Data appendData:[[self Sha2256:[self Sha2256:d]] subdataWithRange:NSMakeRange(0, 4)]];
    
    return [NSString base58WithData:base58Data];
}
...
- (NSData *)base58checkToData {
    ...
    // verify checksum
    NSData *datachecksum1 = [[NSString Sha2256:[NSString Sha2256:data]] subdataWithRange:NSMakeRange(0, 4)];
